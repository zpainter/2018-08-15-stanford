...
address: Alway M112, 300 Pasteur Drive Stanford, CA 94305      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humandate: August 15-16, 2018    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Joe Atzberger", "Matt Durant", "Lori Ling", "Zac Painter" ] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: []     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["postdocprograms@stanford.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes:  http://pad.software-carpentry.org/2018-08-15-stanford           # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
...
<p id="collaborative_notes">
  We will use this <a href="http://pad.software-carpentry.org/2018-08-15-stanford">collaborative document</a> for chatting, taking notes, and sharing URLs and bits of code.
</p>
{% endif %}
